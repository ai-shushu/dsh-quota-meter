...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function QuotaMeter(props) {
			...
			// 请求中亮点（燃烧）：琥珀色火焰感光点，请求期间在剩余段左端持续脉动
			...
			var burnStyle = {
				...
				borderRadius: "50%",
				background: "radial-gradient(circle, color-mix(in srgb, var(--dsw-alias-state-warn-primary) 95%, white), var(--dsw-alias-state-warn-primary) 45%, transparent 72%)",
				boxShadow: "0 0 8px color-mix(in srgb, var(--dsw-alias-state-warn-primary) 60%, transparent)",
